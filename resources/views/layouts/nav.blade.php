                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{asset('dashboard-assets/images/user/avatar-2.jpg')}}" alt="Generic placeholder image">
                                    <div class="media-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{asset('dashboard-assets/images/user/avatar-3.jpg')}}" alt="Generic placeholder image">
                                    <div class="media-body">
